    ...
    <div className="min-h-screen bg-neutral-950 text-white p-8">
      ...
      <section className="mb-12">
        ...
        <div className="flex gap-4">
          <button className="flex flex-col items-center justify-center w-40 h-32 bg-green-500/20 hover:bg-green-500/30 border border-green-500/50 rounded-xl transition cursor-pointer">
            <span className="text-3xl text-green-400 mb-2">+</span>
            <span className="text-sm font-medium text-green-400">Blank Canvas</span>
          </button>
          
          {/* Template Mockups */}
          <button className="flex flex-col items-center justify-center w-40 h-32 bg-neutral-900 border border-neutral-800 rounded-xl hover:border-neutral-600 transition cursor-pointer overflow-hidden">
            <div className="h-2/3 w-full bg-neutral-800"></div>
            <div className="h-1/3 w-full flex items-center justify-center text-xs text-neutral-400">Park Template</div>
          </button>
        </div>
      </section>
